...
//      if (position) {
//        if (this.geolocalisationService.centerOnUser) {
//          this.map.setView(new LatLng(position.coords.latitude, position.coords.longitude));
//          this.geolocalisationService.changeCenterOnUser(false);
//        }
//      } else {
...
//
//    this.geolocalisationService.changeCenterOnUser(true);
//
...
//
//        const rotation = currentPosition.coords.heading ? currentPosition.coords.heading : 45;
//
//
//        this.currentNavigationMarker = new Marker(currentPositionForMarker, {
//          icon: L.icon({
